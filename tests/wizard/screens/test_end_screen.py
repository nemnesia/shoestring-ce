...
from shoestring_ce.wizard.screens.end_screen import patch_end_screen
...
async def test_can_add_settings():
    ...
    # Act:
    screen.add_setting('ふー', 'bar')
    screen.add_setting('alpha', 'おめが')
